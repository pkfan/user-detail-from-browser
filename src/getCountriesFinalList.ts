function get_countries_243() {
  const c_243 = {
    AD: {
      ...
      geo: { region: "Europe", subregion: "Southern Europe" },
    ...
    AE: {
      ...
      geo: { region: "Asia", subregion: "Western Asia" },
      phone: ["+971", "0", [7, 8, 9]],
    },
    AF: {
    ...
    AR: {
      ...
      geo: { region: "Americas", subregion: "South America" },
      phone: ["+54", "0", [8, 9]],
    },
    AS: {
      ...
      geo: { region: "Oceania", subregion: "Polynesia" },
      phone: ["+1684", "1", [10]],
    },
    AT: {
      ...
      geo: { region: "Europe", subregion: "Western Europe" },
    ...
    AU: {
      ...
      geo: { region: "Oceania", subregion: "Australia and New Zealand" },
      phone: ["+61", "0", [9]],
    },
    AZ: {
      name: ["Azerbaijan", "Republic of Azerbaijan", "AZ", "AZE"],
      capital: "Baku",
      currency: { code: "AZN", name: "Azerbaijanian Manat" },
      tld: [".az"],
    ...
    BB: {
      ...
      capital: "Bridgetown",
      currency: { code: "BBD", name: "Barbados Dollar" },
      tld: [".bb"],
      languages: { eng: "English" },
      geo: { region: "Americas", subregion: "Caribbean" },
      phone: ["+1246", "1", [10]],
    },
    BD: {
      name: ["Bangladesh", "People's Republic of Bangladesh", "BD", "BGD"],
      capital: "Dhaka",
      currency: { code: "BDT", name: "Taka" },
      tld: [".bd"],
    ...
    BG: {
      ...
      geo: { region: "Europe", subregion: "Eastern Europe" },
      phone: ["+359", "0", [8, 9, 10]],
    },
    BM: {
      ...
      tld: [".bm"],
      languages: { eng: "English" },
      geo: { region: "Americas", subregion: "Northern America" },
      phone: ["+1441", "1", [10]],
    },
    BN: {
      ...
      tld: [".bn"],
      languages: { msa: "Malay" },
      geo: { region: "Asia", subregion: "South-Eastern Asia" },
      phone: ["+673", "0", [7]],
    },
    BO: {
      name: ["Bolivia", "Plurinational State of Bolivia", "BO", "BOL"],
      capital: "Sucre",
      currency: { code: "BOV", name: "Bolivian Mvdol (funds code)" },
      tld: [".bo"],
      languages: {
        aym: "Aymara",
        grn: "Guaraní",
    ...
    BY: {
      ...
      capital: "Minsk",
      currency: { code: "BYR", name: "Belarussian Ruble" },
      tld: [".by"],
    ...
    BZ: {
      ...
      geo: { region: "Americas", subregion: "Central America" },
      phone: ["+501", "0", [7]],
    },
    CA: {
    ...
    CH: {
      ...
      capital: "Bern",
      currency: { code: "CHE", name: "WIR Euro (complementary currency)" },
      tld: [".ch"],
      languages: {
        fra: "French",
        gsw: "Swiss German",
    ...
    CL: {
      ...
      capital: "Santiago",
      currency: { code: "CLF", name: "Unidad de Fomento (funds code)" },
      tld: [".cl"],
    ...
    CN: {
      ...
      geo: { region: "Asia", subregion: "Eastern Asia" },
    ...
    CV: {
      ...
      capital: "Praia",
      currency: { code: "CVE", name: "Cabo Verde Escudo" },
      tld: [".cv"],
      languages: { por: "Portuguese" },
      geo: { region: "Africa", subregion: "Western Africa" },
      phone: ["+238", null, [7]],
    },
    CX: {
    ...
    DK: {
      ...
      geo: { region: "Europe", subregion: "Northern Europe" },
      phone: ["+45", null, [8]],
    },
    DO: {
    ...
    DZ: {
      ...
      tld: [".dz", "الجزائر."],
      languages: { ara: "Arabic" },
      geo: { region: "Africa", subregion: "Northern Africa" },
      phone: ["+213", "7", [8]],
    },
    EC: {
    ...
    FJ: {
      ...
      capital: "Suva",
      currency: { code: "FJD", name: "Fiji Dollar" },
      tld: [".fj"],
      languages: { eng: "English", fij: "Fijian", hif: "Fiji Hindi" },
      geo: { region: "Oceania", subregion: "Melanesia" },
      phone: ["+679", null, [7]],
    },
    FK: {
    ...
    FM: {
      ...
      tld: [".fm"],
      languages: { eng: "English" },
      geo: { region: "Oceania", subregion: "Micronesia" },
      phone: ["+691", "1", [7]],
    },
    FO: {
    ...
    GT: {
      ...
      currency: { code: "GTQ", name: "Quetzal" },
      tld: [".gt"],
      languages: { spa: "Spanish" },
      geo: { region: "Americas", subregion: "Central America" },
      phone: ["+502", null, [8]],
    ...
    GY: {
      ...
      capital: "Georgetown",
      currency: { code: "GYD", name: "Guyana Dollar" },
      tld: [".gy"],
      languages: { eng: "English" },
      geo: { region: "Americas", subregion: "South America" },
      phone: ["+592", null, [6, 7]],
    ...
    HN: {
      ...
      capital: "Tegucigalpa",
      currency: { code: "HNL", name: "Lempira" },
      tld: [".hn"],
      languages: { spa: "Spanish" },
      geo: { region: "Americas", subregion: "Central America" },
      phone: ["+504", null, [7, 8]],
    ...
    IO: {
      ...
      tld: [".io"],
      languages: { eng: "English" },
      geo: { region: "Africa", subregion: "Eastern Africa" },
      phone: ["+246", "", []],
    },
    IQ: {
    ...
    IS: {
      ...
      capital: "Reykjavik",
      currency: { code: "ISK", name: "Iceland Krona" },
      tld: [".is"],
    ...
    KG: {
      ...
      capital: "Bishkek",
      currency: { code: "KGS", name: "Som" },
      tld: [".kg"],
      languages: { kir: "Kyrgyz", rus: "Russian" },
      geo: { region: "Asia", subregion: "Central Asia" },
      phone: ["+996", "0", [9]],
    },
    KI: {
      name: [
    ...
    LK: {
      ...
      capital: "Colombo",
      currency: { code: "LKR", name: "Sri Lanka Rupee" },
      tld: [".lk", ".இலங்கை", ".ලංකා"],
    ...
    MU: {
      ...
      capital: "Port Louis",
      currency: { code: "MUR", name: "Mauritius Rupee" },
      tld: [".mu"],
    ...
    MV: {
      ...
      capital: "Malé",
      currency: { code: "MVR", name: "Rufiyaa" },
      tld: [".mv"],
    ...
    MZ: {
      ...
      capital: "Maputo",
      currency: { code: "MZN", name: "Mozambique Metical" },
      tld: [".mz"],
      languages: { por: "Portuguese" },
      geo: { region: "Africa", subregion: "Eastern Africa" },
      phone: ["+258", "0", [8, 9]],
    ...
    NA: {
      ...
      geo: { region: "Africa", subregion: "Southern Africa" },
      phone: ["+264", "0", [6, 7]],
    },
    NC: {
    ...
    NI: {
      ...
      capital: "Managua",
      currency: { code: "NIO", name: "Cordoba Oro" },
      tld: [".ni"],
      languages: { spa: "Spanish" },
      geo: { region: "Americas", subregion: "Central America" },
      phone: ["+505", null, [8]],
    ...
    PE: {
      ...
      capital: "Lima",
      currency: { code: "PEN", name: "Nuevo Sol" },
      tld: [".pe"],
    ...
    PY: {
      ...
      capital: "Asunción",
      currency: { code: "PYG", name: "Guarani" },
      tld: [".py"],
      languages: { grn: "Guaraní", spa: "Spanish" },
      geo: { region: "Americas", subregion: "South America" },
      phone: ["+595", "0", [9]],
    ...
    RO: {
      ...
      capital: "Bucharest",
      currency: { code: "RON", name: "New Romanian Leu" },
      tld: [".ro"],
    ...
    SC: {
      ...
      capital: "Victoria",
      currency: { code: "SCR", name: "Seychelles Rupee" },
      tld: [".sc"],
    ...
    SS: {
      ...
      tld: [".ss"],
      languages: { eng: "English" },
      geo: { region: "Africa", subregion: "Middle Africa" },
      phone: ["+211", "0", [9]],
    },
    SE: {
    ...
    SR: {
      ...
      capital: "Paramaribo",
      currency: { code: "SRD", name: "Surinam Dollar" },
      tld: [".sr"],
      languages: { nld: "Dutch" },
      geo: { region: "Americas", subregion: "South America" },
      phone: ["+597", "0", [6]],
    ...
    TM: {
      ...
      capital: "Ashgabat",
      currency: { code: "TMT", name: "Turkmenistan New Manat" },
      tld: [".tm"],
    ...
    TO: {
      ...
      capital: "Nuku'alofa",
      currency: { code: "TOP", name: "Pa’anga" },
      tld: [".to"],
    ...
    UA: {
      ...
      capital: "Kiev",
      currency: { code: "UAH", name: "Hryvnia" },
      tld: [".ua", ".укр"],
    ...
    UZ: {
      ...
      capital: "Tashkent",
      currency: { code: "UZS", name: "Uzbekistan Sum" },
      tld: [".uz"],
    ...
    WF: {
      ...
      capital: "Mata-Utu",
      currency: { code: "XPF", name: "CFP franc (franc Pacifique)" },
      tld: [".wf"],
      languages: { fra: "French" },
      geo: { region: "Oceania", subregion: "Polynesia" },
      phone: ["+681", null, [6]],
    ...
    BA: {
      ...
      capital: "Sarajevo",
      currency: { code: "BAM", name: "Convertible Mark" },
      tld: [".ba"],
    ...
    DJ: {
      ...
      capital: "Djibouti",
      currency: { code: "DJF", name: "Djibouti Franc" },
      tld: [".dj"],
      languages: { ara: "Arabic", fra: "French" },
      geo: { region: "Africa", subregion: "Eastern Africa" },
      phone: ["+253", null, [6]],
    ...
    GH: {
      ...
      capital: "Accra",
      currency: { code: "GHS", name: "Ghana Cedi" },
      tld: [".gh"],
      languages: { eng: "English" },
      geo: { region: "Africa", subregion: "Western Africa" },
    ...
    KM: {
      ...
      capital: "Moroni",
      currency: { code: "KMF", name: "Comoro Franc" },
      tld: [".km"],
    ...
    MR: {
      ...
      capital: "Nouakchott",
      currency: { code: "MRO", name: "Ouguiya" },
      tld: [".mr"],
      languages: { ara: "Arabic" },
      geo: { region: "Africa", subregion: "Western Africa" },
      phone: ["+222", "0", [7]],
    ...
    OM: {
      ...
      capital: "Muscat",
      currency: { code: "OMR", name: "Rial Omani" },
      tld: [".om"],
      languages: { ara: "Arabic" },
      geo: { region: "Asia", subregion: "Western Asia" },
      phone: ["+968", null, [8]],
    ...
    RW: {
      ...
      capital: "Kigali",
      currency: { code: "RWF", name: "Rwanda Franc" },
      tld: [".rw"],
    ...
    SZ: {
      ...
      capital: "Lobamba",
      currency: { code: "SZL", name: "Lilangeni" },
      tld: [".sz"],
    ...
    ZW: {
      ...
      capital: "Harare",
      currency: { code: "ZWL", name: "Zimbabwe Dollar" },
      tld: [".zw"],
      languages: {
        bwg: "Chibarwe",
        eng: "English",
